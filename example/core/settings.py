...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-example-key-change-in-production')
...
# IMPORTANT: Use explicit ISS and JWKS URLs for jwtforge.dev
# Issuer URL must match the token's iss claim
AXIOMS_ISS_URL = os.getenv('AXIOMS_ISS_URL', 'https://jwtforge.dev')

# JWKS URL for fetching public keys
AXIOMS_JWKS_URL = os.getenv('AXIOMS_JWKS_URL', 'https://jwtforge.dev/.well-known/jwks.json')

# Optional: Custom claim names (uncomment if needed)
